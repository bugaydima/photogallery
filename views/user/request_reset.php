...
<head>
  ...
  <title>Admin | Запрос нового пароля</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
        <p class="login-box-msg">Введите Ваш Email для сброса пароля</p>
    ...
    <form action="#" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-5">
            <button type="submit" name="submit" class="btn btn-primary btn-block btn-flat">Сбросить</button>
        </div>
