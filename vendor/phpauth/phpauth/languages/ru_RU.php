...
$lang['system_error'] = "Произошла системная ошибка (проблема с cookie, сессией или базой данных). Попробуйте еще разок.";
...
$lang['email_activation_body'] = 'Здравствуйте,<br/><br/>'
        . 'для входа в систему вам нужно сначала активировать ваш аккаунт. '
        . 'Перейдите пожалуйста по этой ссылке: '
        . '<strong><a href="%1$s/%2$s">%1$s/%2$s</a></strong><br/><br/>'
        . ' и введите следующий ключ активации: <strong>%3$s</strong><br/><br/>'
        . ' Если не регистрировались на сайте %1$s, значит это сообщение вы получили по ошибке.'
